...
:usage
echo.
echo "usage: buildffshaders <shaderProjectName> [-game] [gameDir if -game was specified] [-source sourceDir]"
...
REM ****************
perl "%SrcDirBase%\materialsystem\stdshaders\runvmpi.pl" %FFArgs%
