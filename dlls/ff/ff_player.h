...
public:
	...
	float	GetArmorType() const { return (((float)m_iArmorType) / 10.0f); } //armor type 8 means 0.8 i.e. 80% damage absorbed by armor
...
private:
	...
	int m_iInfectTick;								// infection : number of infection ticks that have occured -Green Mushy
