...
ConVar ffdev_gibdamage("ffdev_gibdamage", "70", FCVAR_FF_FFDEV_REPLICATED, "If a players health is -(ffdev_gibdamage's value) or less after death, then they will gib instead of ragdoll");
