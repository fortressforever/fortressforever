...
#define	FCVAR_ARCHIVE			(1<<7)	// set to cause it to be saved to config.cfg
...
// no cheats versions
//#define FCVAR_FF_FFDEV (FCVAR_NOTIFY)
//#define FCVAR_FF_FFDEV_REPLICATED (FCVAR_NOTIFY|FCVAR_REPLICATED)
//#define FCVAR_FF_CLIENT 0
