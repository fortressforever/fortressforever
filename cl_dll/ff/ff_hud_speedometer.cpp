...
// ELMO *** 
static ConVar hud_speedometer_color( "hud_speedometer_color", "2", FCVAR_ARCHIVE, "1 = Stepped Color 2 = Fading Color (RED > hardcap :: ORANGE > softcap :: GREEN > run speed :: WHITE < run speed)", true, 0.0f, true, 2.0f);
