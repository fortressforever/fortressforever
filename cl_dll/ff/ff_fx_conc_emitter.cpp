...
ConVar conc_refract("ffdev_conc_refract", "0.2", FCVAR_CHEAT);
ConVar conc_grow("ffdev_conc_grow", "0.2", FCVAR_CHEAT);
ConVar conc_shrink("ffdev_conc_shrink", "1.2", FCVAR_CHEAT);
