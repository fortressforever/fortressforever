...
namespace vgui
{
	...
	KeyValues* CFFCustomHudPanelStylePresets::RemoveNonEssentialValues(KeyValues *kvPreset)
	{
		...
		kvTemp->SetInt("panelColorMode", kvPreset->GetInt("panelColorMode", FFQuantityHelper::COLOR_MODE_TEAM));
		...
		kvTemp->SetInt("headerTextAnchorPosition", kvPreset->GetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("headerTextAlignHoriz", kvPreset->GetInt("headerTextAlignHoriz", FFQuantityHelper::ALIGN_LEFT));
		kvTemp->SetInt("headerTextAlignVert", kvPreset->GetInt("headerTextAlignVert", FFQuantityHelper::ALIGN_BOTTOM));
		kvTemp->SetInt("headerTextX", kvPreset->GetInt("headerTextX", 11));
		kvTemp->SetInt("headerTextY", kvPreset->GetInt("headerTextY", -4));
		kvTemp->SetInt("headerTextColorMode", kvPreset->GetInt("headerTextColorMode", FFQuantityHelper::COLOR_MODE_CUSTOM));
		...
		kvTemp->SetInt("headerIconAnchorPosition", kvPreset->GetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("headerIconAlignHoriz", kvPreset->GetInt("headerIconAlignHoriz", FFQuantityHelper::ALIGN_LEFT));
		kvTemp->SetInt("headerIconAlignVert", kvPreset->GetInt("headerIconAlignVert", FFQuantityHelper::ALIGN_BOTTOM));
		kvTemp->SetInt("headerIconX", kvPreset->GetInt("headerIconX", -5));
		kvTemp->SetInt("headerIconY", kvPreset->GetInt("headerIconY", -2));
		kvTemp->SetInt("headerIconColorMode", kvPreset->GetInt("headerIconColorMode", FFQuantityHelper::COLOR_MODE_CUSTOM));
		...
		kvTemp->SetInt("textAnchorPosition", kvPreset->GetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPLEFT));
		kvTemp->SetInt("textAlignHoriz", kvPreset->GetInt("textAlignHoriz", FFQuantityHelper::ALIGN_LEFT));
		kvTemp->SetInt("textAlignVert", kvPreset->GetInt("textAlignVert", FFQuantityHelper::ALIGN_TOP));
		kvTemp->SetInt("textX", kvPreset->GetInt("textX", 5));
		kvTemp->SetInt("textY", kvPreset->GetInt("textY", 5));
		kvTemp->SetInt("textColorMode", kvPreset->GetInt("textColorMode", FFQuantityHelper::COLOR_MODE_CUSTOM));
	...
	void CFFCustomHudPanelStylePresets::UpdatePresetFromControls(KeyValues *kvPreset)
	{
		if(m_pHeaderTextAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPCENTER);
		else if(m_pHeaderTextAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		else if(m_pHeaderTextAnchorPositionMiddleLeft->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		else if(m_pHeaderTextAnchorPositionMiddleCenter->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		else if(m_pHeaderTextAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		else if(m_pHeaderTextAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		else if(m_pHeaderTextAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		else if(m_pHeaderTextAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("headerTextAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);
		...
		if(m_pHeaderIconAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPCENTER);
		else if(m_pHeaderIconAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		else if(m_pHeaderIconAnchorPositionMiddleLeft->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		else if(m_pHeaderIconAnchorPositionMiddleCenter->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		else if(m_pHeaderIconAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		else if(m_pHeaderIconAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		else if(m_pHeaderIconAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		else if(m_pHeaderIconAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("headerIconAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);
		...
		if(m_pTextAnchorPositionTopLeft->IsSelected())
			...
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPCENTER);
		else if(m_pTextAnchorPositionTopRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		else if(m_pTextAnchorPositionMiddleLeft->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		else if(m_pTextAnchorPositionMiddleCenter->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		else if(m_pTextAnchorPositionMiddleRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		else if(m_pTextAnchorPositionBottomLeft->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		else if(m_pTextAnchorPositionBottomCenter->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		else if(m_pTextAnchorPositionBottomRight->IsSelected())
			kvPreset->SetInt("textAnchorPosition", FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);
	...
	void CFFCustomHudPanelStylePresets::ApplyPresetToControls(KeyValues *kvPreset)
	{
		...
		m_pHeaderTextAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPLEFT);
		m_pHeaderTextAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPCENTER);
		m_pHeaderTextAnchorPositionTopRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		m_pHeaderTextAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		m_pHeaderTextAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		m_pHeaderTextAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		m_pHeaderTextAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		m_pHeaderTextAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		m_pHeaderTextAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("headerTextAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);

		m_pHeaderIconAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPLEFT);
		m_pHeaderIconAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPCENTER);
		m_pHeaderIconAnchorPositionTopRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		m_pHeaderIconAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		m_pHeaderIconAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		m_pHeaderIconAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		m_pHeaderIconAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		m_pHeaderIconAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		m_pHeaderIconAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("headerIconAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);

		m_pTextAnchorPositionTopLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPLEFT);
		m_pTextAnchorPositionTopCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPCENTER);
		m_pTextAnchorPositionTopRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_TOPRIGHT);
		m_pTextAnchorPositionMiddleLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLELEFT);
		m_pTextAnchorPositionMiddleCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLECENTER);
		m_pTextAnchorPositionMiddleRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_MIDDLERIGHT);
		m_pTextAnchorPositionBottomLeft->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMLEFT);
		m_pTextAnchorPositionBottomCenter->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMCENTER);
		m_pTextAnchorPositionBottomRight->SetSelected(kvPreset->GetInt("textAnchorPosition", -1) == FFQuantityHelper::ANCHORPOS_BOTTOMRIGHT);
