...
//#define NAPALM_EFFECT			"NapalmBurst"
	...
	ConVar nap_burn_damage("ffdev_nap_burn_damage","15.0",0,"How much damage being in the radius of a napalm grenade deals.");
	ConVar nap_burn_radius("ffdev_nap_burn_radius","98.0",0,"Burn radius of a napalmlet.");
