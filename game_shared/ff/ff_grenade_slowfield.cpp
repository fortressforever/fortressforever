...
ConVar ffdev_slowfield_min_slow_radius("ffdev_slowfield_min_slow_radius", "32", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Minimum slow motion radius of slowfield grenade");
