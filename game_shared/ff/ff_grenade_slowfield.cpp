...
ConVar ffdev_slowfield_radius_outer("ffdev_slowfield_radius_outer", "176", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Outer radius of slowfield grenade (scales from no effect to full effect at inner radius)");
#define SLOWFIELD_RADIUS_OUTER ffdev_slowfield_radius_outer.GetFloat()

ConVar ffdev_slowfield_radius_inner("ffdev_slowfield_radius_inner", "64", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Inner radius of slowfield grenade (where slowfield has full effect)");
#define SLOWFIELD_RADIUS_INNER ffdev_slowfield_radius_inner.GetFloat()

ConVar ffdev_slowfield_radius_power("ffdev_slowfield_radius_power", "1", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Power by which to raise the pecentage that a player is between inner & outer radius of the slowfield grenade (so it ramps up and feels less like a brick wall)");
#define SLOWFIELD_RADIUS_POWER ffdev_slowfield_radius_power.GetFloat()

ConVar ffdev_slowfield_duration("ffdev_slowfield_duration", "7", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Duration of slowfield grenade");
...
ConVar ffdev_slowfield_power("ffdev_slowfield_power", "0.375", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Lower Power = slow fast players more", true, 0.0f, true, 1.0f);
