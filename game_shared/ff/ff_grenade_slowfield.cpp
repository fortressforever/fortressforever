...
ConVar ffdev_slowfield_duration("ffdev_slowfield_duration", "8", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Duration of slowfield grenade");
...
ConVar ffdev_slowfield_min_slow_radius("ffdev_slowfield_min_slow_radius", "128", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "Minimum slow motion radius of slowfield grenade");
...
ConVar ffdev_slowfield_fastspeedmod_start("ffdev_slowfield_fastspeedmod_start", "750", FCVAR_REPLICATED/* | FCVAR_CHEAT */, "When the slowed person is above this speed, they get slowed more depending on how fast they are moving");
