...
ConVar ffdev_ar_rof("ffdev_ar_rof", "0.1", FCVAR_REPLICATED, "Assault Rifle Rate of Fire");
ConVar ffdev_ar_bulletspread("ffdev_ar_bulletspread", "0.07", FCVAR_REPLICATED, "Assault Rifle Bullet Spread");
