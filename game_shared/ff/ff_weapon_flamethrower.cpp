...
ConVar ffdev_flame_uppushforce("ffdev_flame_uppushforce", "120.0", FCVAR_REPLICATED | FCVAR_CHEAT, "Force of upwards push when shooting while off ground");
ConVar ffdev_flame_boostcap("ffdev_flame_boostcap", "550.0", FCVAR_REPLICATED | FCVAR_CHEAT, "Speed at which the flamethrower will stop boosting you");
