...
ConVar ffdev_melee_softcliphitdist("ffdev_melee_softcliphitdist", "24", FCVAR_REPLICATED, "Distance under which melee attacks always hit, as you are assumed to be inside the player under this distance"); //16
