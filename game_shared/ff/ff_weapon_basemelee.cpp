...
ConVar ffdev_melee_maxhitangle("ffdev_melee_maxhitangle", "0.3", FCVAR_FF_FFDEV_REPLICATED); //0.70721f
...
ConVar melee_reach("ffdev_meleereach", "64.0", FCVAR_FF_FFDEV_REPLICATED);
