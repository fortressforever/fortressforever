...
#define INCENDIARYROCKET_MODEL "models/projectiles/rocket/w_rocket.mdl"
...
void CFFProjectileIncendiaryRocket::Explode( trace_t *pTrace, int bitsDamageType )
{
	...
	//----------------------------------------------------------------------------
	void CFFProjectileIncendiaryRocket::CreateSmokeTrail( void )
	{
		// Smoke trail.
	...
	//----------------------------------------------------------------------------
	void CFFProjectileIncendiaryRocket::Spawn( void )
	{
		// Setup
