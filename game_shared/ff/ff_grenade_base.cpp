...
ConVar gren_fric("ffdev_gren_fric", "0.25", FCVAR_REPLICATED);
ConVar gren_elas("ffdev_gren_elas", "0.4", FCVAR_REPLICATED);
ConVar gren_fric_conc("ffdev_gren_fric_conc", "0.3", FCVAR_REPLICATED);
ConVar gren_elas_conc("ffdev_gren_elas_conc", "0.7", FCVAR_REPLICATED);
